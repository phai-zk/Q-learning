...
block_bonus = 0.5  # reward เพิ่มเมื่อ block opponent
Q = {}
...
def choose_action(state_str, available_actions, board, player, epsilon):
...
for episode in range(num_episodes):
	...
	while not done:
		...
		action = choose_action(state_str, available_actions, env.board, player, epsilon)
